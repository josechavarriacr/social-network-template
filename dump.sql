...
CREATE TABLE `block_lists` (
  ...
  `reference_id` int(11) NOT NULL COMMENT 'reference_id = \nfollower_id OR post_id\n',
...
LOCK TABLES `block_lists` WRITE;
/*!40000 ALTER TABLE `block_lists` DISABLE KEYS */;
INSERT INTO `block_lists` VALUES (1,1,1,'0000-00-00 00:00:00'),(2,2,2,'0000-00-00 00:00:00'),(3,3,3,'0000-00-00 00:00:00');
/*!40000 ALTER TABLE `block_lists` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `followers` (
  ...
  CONSTRAINT `fk_followers_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migration` VALUES ('m000000_000000_base',1517706355),('m130524_201442_init',1517706358);
...
CREATE TABLE `notifications` (
  ...
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_notifications_user` (`sender`),
  CONSTRAINT `fk_notifications_user` FOREIGN KEY (`sender`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `posts_likes` (
  ...
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_post_likes_posts` (`post_id`),
...
-- Dump completed on 2018-03-12 22:39:10
